...
class _MyHomePageState extends State<MyHomePage> {
  ...
  onStartControllerEnd(deviceWidth) {
    setState(() {
      ...
      setState(() {
          displayNotification(
              "pomodoro finished", "ready to start  your next one?");
  ...
  onBreakControllerEnd() {
    setState(() {
      ...
      setState(() {
          displayNotification(
            "Break Time",
            "well done ,now you can take 5 minutes break now",
          );
        break1 = false;
        isStart = true;
  ...
  void initializeSetting() async {
    var initializeAndroid = AndroidInitializationSettings('secondary_icon');
  ...
  static const int promdoroTIme = 1;
  static const int breakTime = 2;
